jQuery(function(){
	...
	*/
	...
	jQuery('#cfg-contactform-251 .cfg-uploadfilename').val(''); // FF may keep the file name in the cfg-uploadfilename input after submitting and refreshing the page
	
	jQuery('#cfg-contactform-251 .cfg-captcha-refresh').click(function(){
		
		$('#cfg-contactform-251 .cfg-captcha-img').attr('src','cfg-contactform-251/inc/captcha.php?r=' + Math.random());
	});
	
	jQuery('#cfg-contactform-251 .cfg-submit').click(function(){
		...
		jQuery.post('cfg-contactform-251/inc/form-validation.php',
				{ 
	...
	jQuery('body').on('click', '#cfg-contactform-251 .cfg-deleteupload', function()
	{
