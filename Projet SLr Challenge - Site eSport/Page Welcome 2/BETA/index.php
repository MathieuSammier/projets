               ...
               else
               {
					...
					if(mysql_num_rows($result) > 0)
                    {
                         ...
                         while($row = mysql_fetch_array($result))
                         {
                              ...
                              {
                                   $message = "Le pseudo " . $_POST["pseudo"];
                    ...
                    else
                    {
                         ...
                         else
                         {
                              ...
                              $sujet = "SLr-Challenge | Votre Pré-Inscription sur notre site";
                              
                              $message = "Merci de vous etres pré-enregistrer sur notre site SLr-Challenge !<br />";
							  $message .= "Voici vos informations de connexion: <br />";
							  $message .= "Pseudo: " . $_POST['pseudo'] . "<br />";
							  $message .= "Mot de passe: " . $_POST['mdp'] . "<br />";
							  $message .= "à bientot sur notre site !<br /><br />";
							  $message .= "Voici votre ip: " . $_SERVER['REMOTE_ADDR'];
							  $message .= "</br></br>";
							  $message .= "Vous puvez déjà vous connecter et en voir plus sur notre projet !</br>";
							  $message .= "Vous aurrez aussi un pré accès à l'alpha de notre site, tennez vous aucourant !";
                              
                              // Si une erreur survient
                              if(!@mail($_POST["mail"], $sujet, $message))
                              {
                                   $message = "Une erreur est survenue lors de l'envoi du mail d'inscription<br />\n";
                                   $message .= "Veuillez contacter l'administrateur afin de vérifier si cela ne vous posera pas de problèmes.";
                              }
                              else
                              {
                                   ...
                                   $message .= "Un email vient de vous etre envoyer avec vos informations de connexion.";
		...
		<div class="navbar navbar-default">			
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li><a id="GoToHome" href="#home"  class="selected">Accueil</a></li>
					<li><a id="GoToWorks" href="#work">Informations</a></li>
					<li><a id="GoToFeatures" href="#features">Caractéristiques</a></li>		
					<li><a id="GoToTeam" href="#team">L'équipe</a></li>						
					<li><a id="GoToGallery" href="#gallery">Update</a></li>
					<li><a id="GoToContact" href="#contact">Contact</a></li>							
				</ul>
				<div class="navbar-right">
					<?php if(isset($_SESSION['userid'])) { printf('<a href="conv.php" data-toggle="modal" data-target="#myModal" class="btn">Conversation</a><a href="connexion.php" data-toggle="modal" data-target="#myModal" class="btn">Déconnexion</a>'); }else{ printf('<a href="#myModal" data-toggle="modal" data-target="#myModal" class="btn">Se connecter</a><a href="#myModal" data-toggle="modal" data-target="#myModal" class="btn">S\'inscire</a>'); } ?>
				</div>					
			</div><!--/.nav-collapse -->
		</div>		
	</header>
			...
			<div class="modal-content">			 
				<div class="modal-body">
					<div class="signup">
						...
						<form class="form-horizontal" action="http://<?php echo $_SERVER["SERVER_NAME"] . $_SERVER["SCRIPT_NAME"]; ?>" method="post">						
							<div class="form-group">
								<div class="col-lg-12">
									<input type="text" class="form-control form-block" name="pseudo" placeholder="Entrez votre pseudo">
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-12">
									<input type="text" class="form-control form-block" name ="mail" placeholder="Entrez votre adresse e-mail">
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-12">
									<input type="password" class="form-control form-block" name="mdp" placeholder="Entrez votre mot de passe">
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-12">
									<input type="password" class="form-control form-block" name="C_mdp" placeholder="Confirmez votre mot de passe">
								</div>
							</div>
							<div class="form-group">
								<div class="col-lg-12">
									<button class="btn btn-md" name="inscription">Inscrivez-vous</button>
								</div>									
							</div>									
						</form>	
						<?php } ?>
			...
			<div class="container">
				<div class="row text-center">
					<div class="col-md-10 col-md-offset-1 scrolltop home-intro">
						<ul>
							<li><h3>Everyone<br /> can play</h3></li>
							<li><h3>Everyone<br /> can win</h3></li>
							<li><h3>Everyone<br /> can have fun</h3></li>
						</ul>
					</div>
				</div>
				<div class="row text-center">
