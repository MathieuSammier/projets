...
<html lang="fr"> <!--<![endif]-->
	<head>
		...
		<title>SLr-Challenge - Rejoindre un match</title>
...
onmouseover="this.style.backgroundColor='#404852';" onmouseout="this.style.backgroundColor='#b55d5d';">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
		...
		<li class="dropdown">
          <a href="#" class="dropdown-toggle" style="color: #eee" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Matchs <span class="caret"></span></a>
          <ul class="dropdown-menu">
            <li><a href="matchs-create.php">Créer</a></li>
            <li role="separator" class="divider"></li>
            <li class="active"<a href="matchs-join.php">Rejoindre</a></li>
          </ul>
        </li>
